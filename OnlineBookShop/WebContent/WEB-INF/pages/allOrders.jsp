...
<tr bgcolor="<%=color %>">
<td align="center" >
<form action="showorderinfo.do" method="post">
...
<td align="center">
<font size="3" face="Rupee">`</font>
<font size="3"><b>${oto.totalAmount }</b></font>
</td>
<td align="center">
...
<tr bgcolor="maroon">
<td align="center" colspan="7">
<font color="yellow" size="4" ><b>Information About the order with ID<font color="white">
${ORDER_TO.orderId }</font></b></font>
</td>
</tr>
<tr bgcolor="black">
...
<td align="center">
<font size="3" face="Rupee">`</font><font size="3"><b>
${bto.cost }/-</b></font>
</td>
<td align="center">
...
<table class="textStyle" width="50%" cellspacig="0">
<tr>
...
<tr bgcolor="#fdeaff">
<td><font size="4"><b>Name</b></font>
</td>
<td colspan="2">
<font size="4"><b>${USER_INFO.firstName }
${USER_INFO.middleName } ${USER_INFO.lastName }</b></font>
</td>
</tr>
<tr bgcolor="#dee1fe"> 
<td>
...
<td>
<font size="4"><b>${USER_INFO.email }</b></font>
</td>
</tr>
<tr bgcolor="#e1ffde"> 
<td>
...
<td>
<font size="4"><b>${USER_INFO.phone }</b></font>
</td>
</tr>
</table>
</core:if>
